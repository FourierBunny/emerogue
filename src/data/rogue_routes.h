...
static const struct RogueRouteEncounter sRogueRouteTable[] = {
    ...
    {
        .mapFlags = ROUTE_FLAG_JOHTO,
        .map = ROUTE_MAP(ROGUE_ROUTE_CHAOS1),
        .wildTypeTable = { TYPE_ROCK, TYPE_STEEL, TYPE_FIGHTING },
    },
    {
        .mapFlags = ROUTE_FLAG_KANTO,
        .map = ROUTE_MAP(ROGUE_ROUTE_CHAOS2),
...
static const struct RogueEncounterMap sRogueLegendaryEncounters[] = 
{
    ...
    ENCOUNTER_MAP(SPECIES_WALKING_WAKE, ROGUE_SPECIAL_SUICUNE),
    ENCOUNTER_MAP(SPECIES_IRON_LEAVES, ROGUE_SPECIAL_GEN5_MON),
    ENCOUNTER_MAP(SPECIES_GOUGING_FIRE, ROGUE_SPECIAL_ENTEI),
    ENCOUNTER_MAP(SPECIES_RAGING_BOLT, ROGUE_SPECIAL_RAIKOU),
    ENCOUNTER_MAP(SPECIES_IRON_BOULDER, ROGUE_SPECIAL_GEN5_MON),
    ENCOUNTER_MAP(SPECIES_IRON_CROWN, ROGUE_SPECIAL_GEN5_MON),
    ...
    ENCOUNTER_MAP(SPECIES_ARTICUNO_GALARIAN, ROGUE_SPECIAL_ARTICUNO),
    ENCOUNTER_MAP(SPECIES_ZAPDOS_GALARIAN, ROGUE_SPECIAL_ZAPDOS),
    ENCOUNTER_MAP(SPECIES_MOLTRES_GALARIAN, ROGUE_SPECIAL_MOLTRES),
